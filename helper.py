# file to contain helper functions for main.py
import storage
...
def view_student(field_attributes):
    ...
    # add key-value pair for clubs joined
    ...
    # add key-value pair for activities joined
    ...
    # change the field key into its label
...
def view_class(field_attributes):
    ...
    Cleans up the field_attributes to be more user friendly as well as converting any foreign keys to their respective names / list of names
    '''
    # add key-value pair for students in the class
...
def view_club(field_attributes):
    ...
    Cleans up the field_attributes to be more user friendly as well as converting any foreign keys to their respective names / list of names
    '''
    # add key-value pair for students in the club
...
def view_activity(field_attributes):
    ...
    Cleans up the field_attributes to be more user friendly as well as converting any foreign keys to their respective names / list of names
    '''
    # add key-value pair for students in the activity
